...
params:
  data:
    ...
    value: 'Animal_Move_Data_Prepared.csv'
...
connx <- dbConnect(MySQL(),user="root", db="weka",host="localhost")
dbWriteTable(connx, value = df, name = "tb_mov_animal", row.names=F, append = T)
